...
REVIEW_COMMENTS = {
    ...
    "aluminum": {
        ...
        "lines": [
            ...
            "8 月初印尼实地调研进一步下修供应增量：小K 73 万吨延期、国企 160 万吨停滞、西加项目从「150 万吨 27-28 全投」修正为「明年底先投 50 万吨」、南山宾坦节奏略晚（27 年 13 万吨/28 年 35 万吨），调研方将 27/28 年产量指引下调 62.5/37.4 万吨至 3224.5/3591.6 万吨；印尼纸面产能兑现受孤网电力、国企停滞、机组建设周期三重拖慢。维持海外高成本支撑、远期铝价不宜悲观判断，中东战争常态化未计价，铝价弹性空间打开。",
    ...
    "nickel": {
        ...
        "lines": [
            ...
            "8 月初印尼实地调研：配额不会回到去年宽松状态（政策反复系财政紧张而非营商环境恶化），供给约束常态化；硫磺 700-800 美元/吨是湿法最大成本尾部风险，战争常态化下防范湿法亏现金；6 月 NPI 月产 13.44 万吨环比 -3.4%、IWIP 开炉率仅 66%，配额挤压显化。",
        ],
    },
    "copper": {
        "date": "2026-07-28",
