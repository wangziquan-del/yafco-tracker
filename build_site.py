...
REVIEW_COMMENTS = {
    ...
    "zinc": {
        "date": "2026-07-28",
        "lines": [
            "最新财报季：Teck Red Dog 26Q2 锌精矿 -18%（品位计划内下滑）、Antamina 权益 -62%（入选铜锌比降至 33%），矿端减量集中兑现；指引表 17 家有数值指引，9 家超出、5 家不及——大中型矿山整体仍按计划交付，减量集中在个别老矿。",
            "年度看法：矿端偏紧（TC 持续低位）与冶炼过剩并存，利润分配继续向矿端倾斜；锌的矛盾是「矿紧」何时传导为「锭紧」，需跟踪 TC 拐点与冶炼厂减产信号，在此之前价格弹性弱于铜锡。",
        ],
    },
    "aluminum": {
        "date": "2026-07-28",
